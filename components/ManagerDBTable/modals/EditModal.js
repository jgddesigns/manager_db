...
export default function EditModal({setShowEdit, selectedEmployee, superiorMap, setNewName, setNewEmail, setChangedManager}) {
    ...
    <div>
        <div className="flex w-[40rem] h-[48rem] bg-gray-100 drop-shadow-2xl rounded-xl rounded-tl-[4px] border-[5px] border-[#70AA9B] mb-[10%]  text-black overflow-y-auto">
            <div className="grid grid-rows-2 grid-cols-1 h-[100%]">
                ...
                <div className="mb-8 mt-28 ml-[27%]">
                <div className="mb-8">
                    ...
                    <div className="grid-rows-2 ml-[-1rem] w-[100%] mt-8">
                    ...
                    <div className="w-[100%] text-center mt-[30%] mb-[2%] bottom-0">
                        <span onClick={()=>closeHandler()} className="cursor-pointer h-full underline mr-24">Close</span>
                    </div>
                </div>
                </div>
                </div>
